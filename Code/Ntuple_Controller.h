...
class Ntuple_Controller{
 ...
 public:
  ...
  Int_t TauIndex(){return Ntp->TauIndex;}
  Int_t MuIndex(){return Ntp->MuIndex;}
  ...
  TVector3 MuonTrack_SV(unsigned int i){return TVector3(Ntp->Ref_x->at(i), Ntp->Ref_y->at(i), Ntp->Ref_z->at(i));}
