...
//Select channel, choices are : A1A1, RHORHO, PIONPION, A1RHO, A1PION, RHOPION
string CHANNEL = "A1RHO";
//
...
cout<<"Channel"<<endl;
  ...
  if(channel && std::isnan(Wspin)!=true)
  {
    ...
    if(a1a1){
      ...
      if((TGJminus>TGJminusmax) || (TGJplus>TGJplusmax)) atleastone = true;
      if((TGJminus>TGJminusmax) && (TGJplus>TGJplusmax)) both = true;
...
cout<<"fill reco plots"<<endl;
    ...
    Fraction1.at(t).Fill(atleastone);
    Fraction2.at(t).Fill(both);
    //FastMTT
